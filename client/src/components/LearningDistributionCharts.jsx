...
export default function LearningDistributionCharts() {
    ...
    const ChartSection = ({ title, chartData, color }) => (
        <motion.div
            ...
            className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md rounded-2xl shadow-lg border border-white/50 dark:border-slate-700 p-6 flex flex-col items-center hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
        >
                ...
                <div className="flex gap-2">
                    <button
                        onClick={(e) => {
                            ...
                            copyChartToClipboard(chartId, e.currentTarget);
                        }}
                        className="p-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 rounded-lg transition-colors duration-200 flex items-center gap-2 text-sm font-medium"
                        title="Copy Chart"
                    >
    ...
    return (
        <section className="space-y-8">
            {/* FILTERS */}
            {/* FILTERS */}
            <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md p-6 rounded-2xl shadow-md border border-white/50 dark:border-slate-700 flex flex-wrap gap-4 items-center justify-between">
